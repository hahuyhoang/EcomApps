    ...
    return (
        <SafeAreaView className="flex-1 bg-white ">
            ...
            <View style={styles.horizon} className="mt-3  " >
                <Text style={{ fontFamily: 'Gilroy-Semi' }} className="text-lg ">My Profile</Text>
            </View>
            <View className="items-center">
                <View className="border items-center rounded-full justify-center w-20 h-20">
                    <Image className="items-center rounded-full justify-center w-24 h-24" source={require('../../assets/images/userwhitedog.png')} />
                </View>
            ...
            <View className="flex-1 bg-slate-300 justify-center items-center">
                <Text>
                    lich su xem san pham se hien o day
                </Text>
            </View>
        </SafeAreaView>
    )
